    ...
    <div className='gig'>
      <div className='container'>
        <div className='left'>
          ...
          <SimpleSlider slidesToShow={1} slidesToScroll={1} className="slider" >
            <img
          ...
          <div className='reviews'>
            ...
            <div className='item'>
              <div className='user'>
                <img src='https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto,t_profile_small/v1/attachments/profile/photo/582abdd2296e79a36d42ab847dc74632-1680388139172/895d8ac5-3c3e-481c-b650-96aed81afcbf.jpg' />
                <div className='info'>
                  <span>Jhon doe</span>
              ...
              <div className='stars'>
                <img src='./images/star.com.png' alt='' width="13px" height="13px" />
                <img src='./images/star.com.png' alt='' width="13px" height="13px" />
                <img src='./images/star.com.png' alt='' width="13px" height="13px" />
                <img src='./images/star.com.png' alt='' width="13px" height="13px" />
                <img src='./images/star.com.png' alt='' width="13px" height="13px" />
              ...
              <div className='helpfull'>
                <span>Helpful?</span>
                <img src='./images/like.png' alt='' width="13px" height="13px" />
                <span>yes?</span>
                <img src='./images/dislike.png' alt='' width="13px" height="13px" />
                <span>No?</span>
              </div>
            </div>
            <hr />
        ...
        <div className='right'>
          <p>jkbciwudbcolnacoijnacoiiqjqnxolnqdx</p>
          <p>jkbciwudbcolnacoijnacoiiqjqnxolnqdx</p>
          <p>jkbciwudbcolnacoijnacoiiqjqnxolnqdx</p>
          <p>jkbciwudbcolnacoijnacoiiqjqnxolnqdx</p>
          <p>jkbciwudbcolnacoijnacoiiqjqnxolnqdx</p>
